...
export default function Sidebar() {
  ...
  return (
    <aside className={`relative flex flex-col h-screen bg-white dark:bg-dark-800 border-r border-slate-200 dark:border-dark-700 transition-all duration-300 ease-in-out flex-shrink-0 ${collapsed ? 'w-16' : 'w-64'}`}>
      {/* Logo */}
      <div
